...
public class PermissionDAOImpl extends GenericDAOImpl<Permission> implements IPermissionDAO {

	@Override
	public PageResult query(QueryObject qo) {
		String query = qo.getQuery();
		List<Object> params = qo.getParams();
		String hql = "select count(obj) from Permission obj " + query;
		...
		//----------------------------------------
		hql = "select obj from Permission obj " + query;
