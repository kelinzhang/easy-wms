        ...
        $(function () {
            ...
            $("#edit_table_body")
                    .on("click", ".searchproduct", function () {
                        ...
                        tr.find("[tag=costPrice]").val(ret.costPrice);
                        tr.find("[tag=brand]").text(ret.brandName);
                        tr.find("[tag=pid]").val(ret.id);
                    })
                    .on("blur", "[tag=number],[tag=costPrice]", function () {
                        var tr = $(this).closest("tr");
            ...
            $("input[name='stockIncomeBill.vdate']").click(function () {
                WdatePicker({
                    maxDate:"%y-%M-%d",
                    skin:"twoer"
                });
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <s:textfield name="stockIncomeBill.vdate" cssClass="ui_input_txt02 Wdate"/>
                    </td>
                </tr>
                <tr>
