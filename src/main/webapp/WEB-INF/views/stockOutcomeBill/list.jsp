                ...
                <div id="box_border">
                    ...
                    <div id="box_center">
                        ...
                        <s:select list="#clients" name="qo.clientId" cssClass="ui_select01"
                                  listKey="id" listValue="name" headerValue="所有客户" headerKey="-1"/>
                        审核状态
                        <s:select list="#{-1:'所有',0:'未审核',1:'已审核'}" name="qo.status" cssClass="ui_select01"/>
                    </div>
                    <div id="box_bottom">
                        <input type="button" value="查询" class="ui_input_btn01 btn_page" data-page="1"/>
                        <s:url namespace="/" action="stockOutcomeBill_input" var="url"/>
                ...
                <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                    ...
                    <s:iterator value="#pageResult.listData">
                        <tr>
                            ...
                            <td>
                                <s:if test="status == 0">
                                    <s:a namespace="/" action="stockOutcomeBill_input"> 编辑
                                ...
                                <s:elseif test="status == 1">
                                    <s:a namespace="/" action="stockOutcomeBill_view"> 查看
                                        <s:param name="stockOutcomeBill.id" value="id"/>
                                    </s:a>
                                </s:elseif>
                            </td>
