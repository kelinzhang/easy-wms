...
<%--////////////////////////////////////////////////////////--%>
<s:form name="editForm" namespace="/" action="role_saveOrUpdate.action" method="post" id="editForm">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <table>
                            <tr>
                                <td>
                                    <s:select list="#permissions" multiple="true" listKey="id" listValue="name"
                                ...
                                <td>
                                    <s:select list="role.permissions" name="role.permissions.id" multiple="true"
                                              listKey="id" listValue="name" cssClass="ui_multiselect01 selected_permissions"/>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <table>
                            <tr>
                                <td>
                                    <s:select list="#menus" multiple="true" listKey="id" listValue="name"
                                              cssClass="ui_multiselect01 all_menus"/>
                                </td>
                                <td align="center">
                                ...
                                <td>
                                    <s:select list="role.menus" name="role.menus.id" multiple="true"
                                              listKey="id" listValue="name" cssClass="ui_multiselect01 selected_menus"/>
                                </td>
                            </tr>
                        </table>
                    </td>
